...
4. Go back to "Tags" and select your GA account. Create Custom Dimensions starting with numeral 1 as the index and then connecting it to the variales you setup before. Trigger All Pages. (In our code below we put in inactive dimensions for dimension3-5).
